package com.org.MovieTicket.Controller;
...
import com.org.MovieTicket.Repository.BookingRepository;
import com.org.MovieTicket.Repository.CustomerRepository;
import com.org.MovieTicket.Repository.SeatRepository;
...
public class CustomerController {
	...
	public String bookShow(@PathVariable int showId, ModelMap map) {
		...
		java.util.List<Seat> seats = show.getScreen().getSeats();
		map.put("show", show);
		map.put("seats", seats);
	...
	public String bookSeats(@RequestParam int showId, @RequestParam java.util.List<String> selectedSeats, HttpSession session,
			ModelMap map)
			throws RazorpayException {
		Customer customer = (Customer) session.getAttribute("customer");
		if (customer != null) {
			Show show = showRepository.findById(showId).orElseThrow();
			java.util.List<Seat> seats = seatRepository.findBySeatNumberIn(selectedSeats);
			...
			java.util.List<Booking> list = customer.getBookingList();
			list.add(booking);
